...
namespace WebApplication10
{
    ...
    {
        public List<NetworkInfo> SuccessfullPings { get; set; }

        public NetworkHelper()
        {
            SuccessfullPings = new List<NetworkInfo> {};
        }
        ...
        private void PingCompleted(object sender, PingCompletedEventArgs e)
        {
            ...
            if (e.Reply != null && e.Reply.Status == IPStatus.Success)
            {
                ...
                NetworkInfo pingResults = new NetworkInfo {hostname = hostname, ip = ip, macaddress = macaddres};
